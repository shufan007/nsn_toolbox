...
class ResultAnalysis(object):
    ...
    def __init__(self, Paras):
        ...
        self.valueMinList  = []
        self.valueMaxList  = [] 
        self.checkOnPerReportSwitch = None
    ...
    def split_paras(self):
        ...
        if (len(self.Paras) -2)%3 == 0:
            ...
            self.checkOnPerReportSwitch = self.Paras[1]
            
            if self.checkOnPerReportSwitch.upper() != 'TRUE' and self.checkOnPerReportSwitch.upper() != 'FALSE': 
                print "** checkOnPerReportSwitch should be True/true, False/false."
                exit(2)
    ...
    def check_data(self):
        ...
        if self.checkOnPerReportSwitch.upper() == 'TRUE':
            
            if matched_num == self.data_len:
                print " * check * PASS!"
                print " ********************************************** "
                exit(0)
            else:
        ...
        elif self.checkOnPerReportSwitch.upper() == 'FALSE':
            if matched_num > 0:
                print " * check * PASS!"
                print " ********************************************** "
                exit(0)
...
if __name__ == '__main__':
   ...
   *************************** Usage: ***************************
        -input:
             -[1] msgID	
             -[2] checkOnPerReportSwitch (True/true or False/false)
             -[3] FieldName1	
             -[4] valueMin1             
             -[5] valueMax1
       ...
       @example:
               python ResultAnalysis.py 5184 True FieldName1 valueMin1 valueMax1
